...
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Thin", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Thin", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Thin", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "ExtraLight", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "ExtraLight", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Light", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Light", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Regular", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Regular", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Medium", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Medium", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "DemiBold", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "DemiBold", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Bold", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "Bold", stretch = "Normal", style = "Italic" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "ExtraBold", stretch = "Normal", style = "Normal" })
-- wezterm.font("JetBrainsMono Nerd Font Mono", { weight = "ExtraBold", stretch = "Normal", style = "Italic" })
